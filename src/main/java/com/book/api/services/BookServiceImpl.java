...
@Slf4j // This is from Lombok and automatically generates a logger field for you. Can use use log.info(), log.error() without declaration
@Service //@Service: "Oh, I need to create a UserService object"
public class BookServiceImpl implements BookService {

    @Value("${project.images}") // make my "project.images" to be path
    private String path;
    ...
    @Override
    public BookDto addBook(BookDto bookDto, MultipartFile file) throws IOException { //MultipartFile : abstract class for file dealing methods
